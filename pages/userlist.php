		...
		if(count($arrayResult) == 0){
			...
			foreach ($arrayResult as $dataUser) {
				echo '<tr>';
					...
					echo '<td><a class="btn btn-warning btn-sm"  href="dashboardadmin.php?p=user&id='.$dataUser->id.'">Edit</a> |
   					          <a class="btn btn-danger btn-sm"  href="dashboardadmin.php?p=deleteuser&id='.$dataUser->id.'" 
